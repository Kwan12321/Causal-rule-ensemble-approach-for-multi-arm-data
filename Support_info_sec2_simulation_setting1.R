...
#dir <- "Z:/MCRE/"
#dir.save <- "D:/MCRE/"
#dir.save <- "C:/Users/pc08/Desktop/MCRE"
dir <- dir.save <- getwd()
##########################

source(paste0(dir, "/data_gen_overlap.R"))
...
#for(m in 19:27){  
  ...
  sim_fun <- function(seed){
    ...
    ### Create the dataset ###
    sim.train <- data_gen_overlap(n = n, p = p, Beta = Beta.can[1:mod$g,], model = mod[2:3], overlap = mod$prob, seed = seed)
    sim.test <- data_gen_overlap(n = n, p = p, Beta = Beta.can[1:mod$g,], model = mod[2:3], overlap = mod$prob, seed = seed + 100)
    ...
    save.res <- paste0(dir.save, "/add_simulation/Section2_setting1/prop",mod$sim,"_n",n,"_p",p,"_",mod$prob,"_",mod$g,"g","_ite",seed,".csv")
  ...
  save.res <- paste0(dir.save, "/add_simulation/Section2_setting1/prop_evl_sim",mod$sim,"_n",n,"_p",p,"_",mod$prob,"_",mod$g,"g",".csv")
