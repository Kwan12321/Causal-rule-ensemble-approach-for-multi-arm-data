...
#for(m in 19:27){  
  ...
  sim_fun <- function(seed){
    ...
    save.res <- paste0(dir.save, "/main_simulation/prop/prop",mod$sim,"_n",n,"_p",p,"_",mod$prob,"_",mod$g,"g","_ite",seed,".csv")
  ...
  save.res <- paste0(dir.save, "/main_simulation/prop/prop_evl_sim",mod$sim,"_n",n,"_p",p,"_",mod$prob,"_",mod$g,"g",".csv")
